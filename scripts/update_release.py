...
def update_appcast(version, desc):
    ...
    version_info = {
        ...
        'desc': desc,
        'sha256': file_hash,
        'url': f'https://github.com/cdpath/bob-plugin-claude-translator/releases/download/v{version}/{release_file.name}',
        'minBobVersion': '1.8.0'
    }
    ...
    if appcast_file.is_file():
        ...
        appcast = dict(identifier='cdpath.claude.translator', versions=[])
